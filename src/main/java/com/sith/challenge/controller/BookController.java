...
public class BookController {
    ...
    @RequestMapping(value = "/books/author/{author_id}", method = RequestMethod.GET)
    public List<Book> getBooksFromAuthor(@PathVariable int author_id) {
        DaoBook db = new DaoBook();
        return db.readAllBooksFromAuthor(author_id);
    }
